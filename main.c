...
const char* getStringFromDay(enum weekDays day) {
    switch(day) {
        case Mon: return "Monday"; // If the above method returned Mon then return the string "Monday"
        case Tue: return "Tuesday";// If the above method returned Tue then return the string "Monday"
        case Wed: return "Wednesday";// If the above method returned wed then return the string "Monday"
        case Thur: return "Thursday";// If the above method returned Thur then return the string "Monday"
        case Fri: return "Friday";// If the above method returned Fri then return the string "Monday"
        case Sat: return "Saturday";// If the above method returned Sat then return the string "Monday"
        case Sun: return "Sunday";// If the above method returned Sun then return the string "Monday"
        default: return "Invalid";// otherwise if nothing is returned we give invalid
    }
}
...
{       enum weekDays wd;
    ...
    scanf("%s", inputDay); // user enters a day as a string like Mon, Tue etc


// dayValue is the enum i get returned from the getweekdayfromstring function
 enum weekDays dayValue = getWeekDayFromString(inputDay); 
    // if dayvalue is an invalid input. Not Mon, Tue... etc then we print "invalid day"
